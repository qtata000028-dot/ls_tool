...
const Navbar: React.FC<NavbarProps> = ({ user, profile, onLogout }) => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#020617]/40 backdrop-blur-md border-b border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3 group cursor-pointer">
            ...
            <span className="text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-400 tracking-tight">
              {APP_NAME}
            </span>
          </div>
